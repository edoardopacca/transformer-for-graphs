...
% Figures live in the repo's runs/ directory; this file sits in report/2/,
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_3352759/n10_p0.2_rep0/retrain_er_p02_accuracy.png}
        \caption{Exact match and pairwise accuracy ($p = 0.2$).}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_3352759/n10_p0.2_rep0/retrain_er_p02_train_loss.png}
    ...
    \begin{subfigure}[t]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_3352759/n10_p0.2_rep0/per_distance_accuracy_small_multiples_p02.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_3352759/n10_p0.5_rep0/retrain_er_p05_accuracy.png}
        \caption{Exact match and pairwise accuracy ($p = 0.5$).}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_3352759/n10_p0.5_rep0/retrain_er_p05_train_loss.png}
    ...
    \begin{subfigure}[t]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_3352759/n10_p0.5_rep0/per_distance_accuracy_small_multiples_p05.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_2chains_3352759/n14_k7_rep0/retrain_two_chains_k07_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_2chains_3352759/n14_k7_rep0/retrain_two_chains_k07_train_loss.png}
    ...
    \begin{subfigure}[t]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_2chains_3352759/n14_k7_rep0/per_distance_accuracy_small_multiples_k07.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_2chains_per_distance_bars.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_2cliques_3352759/n14_k7_rep0/retrain_two_cliques_k07_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_2cliques_3352759/n14_k7_rep0/retrain_two_cliques_k07_train_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_2cliques_3352759/n14_k7_rep0/per_distance_accuracy_small_multiples_k07.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_2cliques_per_distance_bars.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{runs/report2/n40_cross_experiment/01_convergence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{runs/report2/n40_cross_experiment/02_per_distance.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{runs/report2/ood_cross_experiment/ood_cross_chains_per_distance.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_cross_per_diam_bucket.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485350/n40_p005_unfiltered/er_n40_unfiltered_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485350/n40_p005_unfiltered/er_n40_unfiltered_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485350/n40_p005_unfiltered/er_n40_unfiltered_per_diam_bucket.png}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485350/n40_p005_unfiltered/er_n40_unfiltered_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.66\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_unfiltered_per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_unfiltered_per_diam_bucket.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485352/n40_p005_diam11/er_n40_diam11_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485352/n40_p005_diam11/er_n40_diam11_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485352/n40_p005_diam11/er_n40_diam11_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485352/n40_p005_diam11/er_n40_diam11_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.66\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_diam11_per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_diam11_per_diam_bucket.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \caption{$D \le 11$, OOD.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485351/n40_p005_diam9/er_n40_diam9_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485351/n40_p005_diam9/er_n40_diam9_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485351/n40_p005_diam9/er_n40_diam9_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485351/n40_p005_diam9/er_n40_diam9_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.66\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_diam9_per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_diam9_per_diam_bucket.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \caption{$D \le 9$, OOD.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485353/n40_p005_diam7/er_n40_diam7_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485353/n40_p005_diam7/er_n40_diam7_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485353/n40_p005_diam7/er_n40_diam7_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_485353/n40_p005_diam7/er_n40_diam7_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.66\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_diam7_per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_cross_experiment/ood_n40_diam7_per_diam_bucket.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \caption{$D \le 7$, OOD.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495903/n40_p005_unfiltered_big/er_n40_unfiltered_big_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495903/n40_p005_unfiltered_big/er_n40_unfiltered_big_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495903/n40_p005_unfiltered_big/er_n40_unfiltered_big_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495903/n40_p005_unfiltered_big/er_n40_unfiltered_big_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.85\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_unfiltered_to_structured/per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_unfiltered_to_structured/per_diam_bucket_ood.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_unfiltered_to_structured/per_n_active.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_494467/n40_p005_diam11_big/er_n40_diam11_big_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_494467/n40_p005_diam11_big/er_n40_diam11_big_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_494467/n40_p005_diam11_big/er_n40_diam11_big_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_494467/n40_p005_diam11_big/er_n40_diam11_big_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.85\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam11_to_structured/per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam11_to_structured/per_diam_bucket_ood.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam11_to_structured/per_n_active.png}
        \caption{Exact match on 2-chains and 2-cliques as a function of
        $n_{\text{active}}$.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495198/n40_p005_diam9_big/er_n40_diam9_big_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495198/n40_p005_diam9_big/er_n40_diam9_big_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495198/n40_p005_diam9_big/er_n40_diam9_big_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495198/n40_p005_diam9_big/er_n40_diam9_big_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.85\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam9_to_structured/per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam9_to_structured/per_diam_bucket_ood.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam9_to_structured/per_n_active.png}
        \caption{Exact match on 2-chains and 2-cliques as a function of
        $n_{\text{active}}$.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495199/n40_p005_diam7_big/er_n40_diam7_big_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495199/n40_p005_diam7_big/er_n40_diam7_big_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495199/n40_p005_diam7_big/er_n40_diam7_big_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/retrain_er_n40_big_495199/n40_p005_diam7_big/er_n40_diam7_big_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.85\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam7_to_structured/per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam7_to_structured/per_diam_bucket_ood.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_n40_big_495904/er_n40_big_diam7_to_structured/per_n_active.png}
        \caption{Exact match on 2-chains and 2-cliques as a function of
        $n_{\text{active}}$.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/curriculum_er_n40_big_494470/n40_p005_curriculum_big/curriculum_er_n40_big_accuracy.png}
        \caption{Exact match and pairwise accuracy.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/curriculum_er_n40_big_494470/n40_p005_curriculum_big/curriculum_er_n40_big_loss.png}
        \caption{Training loss.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/curriculum_er_n40_big_494470/n40_p005_curriculum_big/curriculum_er_n40_big_per_diam_bucket.png}
        \caption{Exact match per test-graph diameter bucket.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/curriculum_er_n40_big_494470/n40_p005_curriculum_big/curriculum_er_n40_big_per_dist_sm.png}
        \caption{Pairwise accuracy by shortest-path distance. The number above each panel is the count of test pairs at that distance.}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.85\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_curriculum_big_494472/er_n40_big_curriculum_to_structured/per_distance_bars.png}
        \caption{Per-distance pairwise accuracy on the three OOD sets.}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_curriculum_big_494472/er_n40_big_curriculum_to_structured/per_diam_bucket_ood.png}
        \caption{Exact match on unfiltered ER by diameter bucket.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{runs/report2/ood_eval_curriculum_big_494472/er_n40_big_curriculum_to_structured/per_n_active.png}
        \caption{Exact match on 2-chains and 2-cliques as a function of
        $n_{\text{active}}$.}
    \end{subfigure}
